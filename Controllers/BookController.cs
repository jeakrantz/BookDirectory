...
namespace BookDirectory.Controllers
{
    public class BookController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Year,Score,AuthorId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Year,Score,AuthorId")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
